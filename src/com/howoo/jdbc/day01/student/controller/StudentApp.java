package com.howoo.jdbc.day01.student.controller;

import java.util.List;

import com.howoo.jdbc.day01.student.model.ManageStudent;
import com.howoo.jdbc.day01.student.model.Student;
import com.howoo.jdbc.day01.student.view.ViewStudent;
...
//				index = manage.searchIndexByName(name);
				// index와 student 를 넘겨서 해당 위치의
				// 개체를 replace함.
//				manage.setStudent(index, student);
				result = manage.setStudent(student);
				if(result > 0) {
					view.displayMsg("수정 완료");
				}else {
					view.displayMsg("수정 실패");
				}
				break;
			case 5: 
				// 삭제할 학생 이름 입력받음
...
//				index = manage.searchIndexByName(name);
			...
			case 0: 
				...
				break finish;
			default: 
				view.displayMsg("1 ~ 6 사이의 수를 입력해주세요");
				break;
			}
		}
	}
